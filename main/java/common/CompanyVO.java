...
public class CompanyVO {
	...
	private String Employcase;
	private String Paytype;
	private String Severance;
	private String Worktime;
	private String Etc;
	private int	Recrusize;
	...
	public String getEmploycase() {
		return Employcase;
	}

	public void setEmploycase(String employcase) {
		Employcase = employcase;
	}
	...
	public int getRecrusize() {
		return Recrusize;
	}

	public void setRecrusize(int recrusize) {
		Recrusize = recrusize;
	}
